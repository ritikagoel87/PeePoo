...
Booking.destroy_all
b1 = Booking.create(:timeIn => '10:00:00', :timeOut => '10:20:00', :amount => 4.00, :amenity_id => a2.id, :user_id => u1.id, :payment => true )
b2 = Booking.create(:timeIn => '11:00:00', :timeOut => '11:05:00', :amount => 2.00, :amenity_id => a1.id, :user_id => u2.id, :payment => false )
b3 = Booking.create(:timeIn => '13:00:00', :timeOut => '13:40:00', :amount => 400.00, :amenity_id => a7.id, :user_id => u3.id, :payment => true )
b4 = Booking.create(:timeIn => '09:15:00', :timeOut => '09:40:00', :amount => 30.00, :amenity_id => a8.id, :user_id => u5.id, :payment => false )
